...
SECRET_KEY = 'django-insecure-%q*z1a3jyn%y55-e=m$_vt%pnb1n*glwktry0i)wrh367u3rby'
...
cloudinary.config(
    ...
    api_secret = "tJpmpfsHYxmjehBFFObwHPHGkP8", # Click 'View API Keys' above to copy your API secret
    secure=True
)
